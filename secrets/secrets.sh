...
# kseal "${REPO_ROOT}/deployments/default/goldilocks/goldilocks-helm-values.txt"
...
kseal "${REPO_ROOT}/deployments/default/external-dns/external-dns-helm-values.txt"
