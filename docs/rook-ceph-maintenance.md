...
rbd map -p replicapool csi-vol-2c035fd6-9a76-11eb-ae97-9a71104156fa \
    | xargs -I{} mount {} /mnt/data

rm -rf /mnt/data/*
tar xvf /mnt/nfs/backups/lidarr.tar.gz -C /mnt/data
# chown -R 568:568 /mnt/data/

umount /mnt/data && \
rbd unmap -p replicapool csi-vol-2c035fd6-9a76-11eb-ae97-9a71104156fa
```
