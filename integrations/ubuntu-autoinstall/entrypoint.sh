...
rm -f /build/ubuntu-20.04.2-live-server-amd64-autoinstall-masters.iso
rm -f /build/ubuntu-20.04.2-live-server-amd64-autoinstall-workers.iso

if [ ! -f /build/ubuntu-20.04.2-live-server-amd64.iso ]; then
    curl -L -o /build/ubuntu-20.04.2-live-server-amd64.iso https://releases.ubuntu.com/20.04/ubuntu-20.04.2-live-server-amd64.iso
fi

7z x /build/ubuntu-20.04.2-live-server-amd64.iso -oiso
